...
// add tests
suite.add('JudyNode#Inserts#' + count,
function() {
 ...
 suite.add('JudyNode#Retrieves#' + count,
function() {
    var judy = new judynode.Judy();
    for (var i = 0; i < count; i++) {
 ...
 suite.add('JudyNode#RandomRetrieves#' + count,
function() {
    var judy = new judynode.Judy();
    for (var i = 0; i < count; i++) {
        var value = randomString(i * multiplier);
 ...
 suite.add('JudyNode#Misses#' + count,
function() {
    var judy = new judynode.Judy();
    for (var i = 0; i < count; i++) {
        var value = randomString(i * multiplier);
 ...
 suite.add('JudyNode#Deletes#' + count,
function() {
    var judy = new judynode.Judy();
    for (var i = 0; i < count; i++) {
        var value = randomString(i * multiplier);
